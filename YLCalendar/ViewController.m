...
- (void)viewDidLoad {
    ...
    YLCalendarView *calendarView = [[YLCalendarView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 352)];
    ...
    [self getChineseMonthWithDate:[NSDate date]];
    [self getChineseCalendarWithDate:[NSDate date]];
...
-(NSString*)getChineseCalendarWithDate:(NSDate *)date{
    ...
    NSLog(@"chineseCal_str == %@", chineseCal_str);
